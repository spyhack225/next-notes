    ...
    private static func measure(
        ...
        do {
            ...
            do {
                ...
                Log.speech.error("\(name, privacy: .public) stream failed: \(error.localizedDescription, privacy: .public)")
            ...
            Log.speech.error("\(name, privacy: .public) comparison failed: \(error.localizedDescription, privacy: .public)")
            await engine.finish()
